...
import com.techwiz.pockethishab.adapter.expenseAdapter;
import com.techwiz.pockethishab.adapter.incomeAdapter;
...
public class Dashboard extends Fragment {
    ...
    private void fillExpenseModel() {
        ...
        tv_expense.setText("Tk." + totalExpense);
    ...
    private void fillIncomeModel() {
        ...
        tv_income.setText("Tk." + totalIncome);
    ...
    private void init(View root) {
        ...
        tv_income.setText("Tk. 11000");
        tv_expense.setText("Tk. 8000");
